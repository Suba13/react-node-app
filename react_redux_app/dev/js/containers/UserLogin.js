            ...
            <div className="bgColor">
                ...
                <form>
                    ...
                    <p className="marginPhone">Phone Number :<input className="phoneInput" type="number"
                       placeholder="Enter your phone number...!" name="phone" onKeyDown={this.enterKeyHandling} onChange={(e)=>this.onChangeHandler(e)}
                    ...
                    <p className="marginName">Name : <input className="nameInput" type="text" name="name"
                       placeholder="Enter your name...!" onKeyDown={this.enterKeyHandling}
                        onChange={(e)=>this.onChangeHandler(e)} ></input></p>
                    <Link to="/item-List"> <button className="marginLoginBtn" type="button"
                        onClick={()=>this.props.userLogging(this.state.loginUser)}>Login</button></Link>
                </form>
            </div>
        );
    }
